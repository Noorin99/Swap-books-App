...
// import { ReactComponent as VGood } from "../../assets/icons/vgood.svg";
                    ...
                    <FormControlLabel
                      ...
                      control={
                        <IconButton onClick={()=>handleChecked("good")} >
                          <Good
                            style={{ width: 50, height: 50, fill: (books.status==="good"?"green":"lightgray") }}
                          />
                        </IconButton>
                      }
                    ...
                    <FormControlLabel
                      ...
                      control={
                        <IconButton  onClick={()=>handleChecked("verygood")}>
                         <Good
                            style={{ width: 50, height: 50, fill: (books.status==="verygood"?"green":"lightgray") }}
                          />
                        </IconButton>
                      }
                      labelPlacement="bottom"
                    ...
                    <FormControlLabel
                      ...
                      control={
                        <IconButton  onClick={()=>handleChecked("execlent")}>
                            <Good
                            style={{ width: 50, height: 50, fill: (books.status==="execlent"?"green":"lightgray") }}
                          />
                        </IconButton>
                      }
                      labelPlacement="bottom"
